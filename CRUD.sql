...
insert into aluno(nome, --> Passamos o nome da tabela, 'aluno', e os campos que queremos preencher.
    ...
    values('Guru', --> Passamos os valores dos campos, já com os valores preenchidos na ordem correta.
    '99999999999',
...
--> Para atualizar, passamos o nome da tabela 'aluno', o campo que será atualizado, utilizando o 'set', 
--> o campo 'dinheiro', o valor '1000.90' e estabelecemos qual dado será atualizado por meio do 
--> 'where' e do 'id'.
...
--> Ao invés de retornar todos os campos utilizando o (*), podemos passar o nome das colunas que 
--> queremos retornar no select, passando o nome de cada uma delas.
