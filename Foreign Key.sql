...
-- JOIN, ou seja, estou trazendo os registros que possuem valores correspondentes em ambas as tabelas.
...
-- LEFT JOIN, ou seja, está retornando todos os registros da tabela 'esquerda' com os registros correspondentes da tabela 'direita'.
...
-- RIGHT JOIN, ou seja, está retornando todos os registros da tabela 'direita' com os registros correspondentes da tabela 'esquerda'.
...
-- FULL JOIN, ou seja, está retornando todos os registros quando há uma correspondência na tabela da 'esquerda' ou da 'direita'.
...
-- CROSS JOIN, ou seja, isso corresponde a todos os registros da tabela da 'esquerda' com cada registro da tabela 'direita', isso significa que 
-- todos os registros da tabela 'direita' serão retornados para cada registro da tabela 'esquerda'.
...
-- Para deletar um dado que possui chave estrangeira, temos que excluir todos os campos, de todas as tabelas que esse dado está vinculado, 
-- por exemplo, no caso aqui, a tabela 'aluno' está vinculada a tabela 'aluno_curso', ou seja, para excluir um dado da tabela 'aluno', temos 
-- que excluir primeiro os dados da tabela 'aluno_curso'.
