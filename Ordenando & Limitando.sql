...
-- Seleciona todos os registros da tabela 'funcionarios', ordena os resultados em ordem crescente pelo ID do funcionário (ORDER BY), limita o número de resultados retornados para 5 (LIMIT),
-- desloca o ponto de partida do resultado para o segundo registro, uma paginação, (OFFSET), fazendo que o primeiro registro não apareça na consulta.
