...
Também é possível negar essa pesquisa, falando para trazer todos os dados que sejam diferentes dos digitados 
...
( _ ), esse caractere  já substitui tudo que for necessário, por exemplo, se eu quiser pesquisar todos os 
